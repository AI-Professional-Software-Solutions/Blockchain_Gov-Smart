...
func NewWebsocketsAPI(apiStore *api_common.APIStore, apiCommon *api_common.APICommon, chain *blockchain.Blockchain, settings *settings.Settings, mempool *mempool.Mempool) *APIWebsockets {
	...
	api.GetMap = map[string]func(conn *connection.AdvancedConnection, values []byte) (interface{}, error){
		...
		"wallet/private-create-asset":          api_code_websockets.HandleAuthenticated[api_common.APIWalletPrivateCreateAssetRequest, api_common.APIWalletPrivateCreateAssetReply](api.apiCommon.WalletPrivateCreateAsset),
		"wallet/private-fund-plain-account":    api_code_websockets.HandleAuthenticated[api_common.APIWalletPrivateFundPlainAccountRequest, api_common.APIWalletPrivateFundPlainAccountReply](api.apiCommon.WalletPrivateFundPlainAccount),
		"wallet/private-asset-supply-increase": api_code_websockets.HandleAuthenticated[api_common.APIWalletPrivateAssetSupplyIncreaseRequest, api_common.APIWalletPrivateAssetSupplyIncreaseReply](api.apiCommon.WalletPrivateAssetSupplyIncrease),
		"wallet/update-asset-fee-liquidity":    api_code_websockets.HandleAuthenticated[api_common.APIWalletUpdateAssetFeeLiquidityRequest, api_common.APIWalletUpdateAssetFeeLiquidityReply](api.apiCommon.WalletUpdateAssetFeeLiquidity),
